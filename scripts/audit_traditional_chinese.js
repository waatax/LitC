...
const convertBounded = (text) => {
  const protectedTerms = [
    ...
    '數以萬里', '數千里', '數百里', '三百里', '三里的', '七里的', '九萬里',
    '廣衍數於萬，不勝而辟',
    '免攻伐并兼', '禹征三苗', '征三苗', '三處「于」', '于／於',
    '疲困', '只說',
    '才去做', '才有用', '河川谷地', '「于」', '「于民」', '照于四方', '繼明照于四方',
    '群百工', '吃飯', '以斗斟酌', '斗以酌', '辟風寒', '「辟」', '「于是」', '于是／於是',
    '游者愛佼', '「凶」', '凶、餽', '凶饑', '凶歉', '凶年', '凶荒', '征討', '《群書治要》', '逞凶', '逞凶鬥狠',
    '東征', '出征', '南征', '北征', '西征', '長征', '征戰', '征伐', '征服', '身征', '親征', '遠征',
    '少長咸集', '民咸', '咸服', '咸歸', '咸集', '群賢咸集', '羣賢咸集', '老少咸宜', '咸池', '咸卦', '咸感',
    '余嘉', '余聞', '余讀', '余曰', '余嘗', '余思', '余觀', '余竊', '余不知', '余以為', '亭長告余曰',
