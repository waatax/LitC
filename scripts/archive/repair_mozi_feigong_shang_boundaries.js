...
for (const passage of passages.filter(item => item.chapterId === 'mo-zi_ch-17')) {
...
console.log('Rebuilt sentence boundaries for 《墨子·非攻上》2 passages; canonical wording preserved.')
