...
const mengziChapters = chapters.filter((c) => c.workId === 'meng-zi').slice(8, 10);
...
fs.writeFileSync(path.join(root, 'scratch/mengzi_ch9_ch10.json'), JSON.stringify(result, null, 2), 'utf8');
