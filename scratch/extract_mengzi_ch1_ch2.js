...
const mengziChapters = chapters.filter((c) => c.workId === 'meng-zi').slice(0, 2);
...
fs.writeFileSync(path.join(root, 'scratch/mengzi_ch1_ch2.json'), JSON.stringify(result, null, 2), 'utf8');
