...
const mengziChapters = chapters.filter((c) => c.workId === 'meng-zi').slice(10, 12);
...
fs.writeFileSync(path.join(root, 'scratch/mengzi_ch11_ch12.json'), JSON.stringify(result, null, 2), 'utf8');
