...
const mengziChapters = chapters.filter((c) => c.workId === 'meng-zi').slice(6, 8);
...
fs.writeFileSync(path.join(root, 'scratch/mengzi_ch7_ch8.json'), JSON.stringify(result, null, 2), 'utf8');
