...
const mengziChapters = chapters.filter((c) => c.workId === 'meng-zi').slice(12, 14);
...
fs.writeFileSync(path.join(root, 'scratch/mengzi_ch13_ch14.json'), JSON.stringify(result, null, 2), 'utf8');
